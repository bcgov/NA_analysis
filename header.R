...
HFLibrary<-file.path('/Users/darkbabine/Dropbox (BVRC)/_dev/Biodiversity/BC_HumanFootprint/out/spatial')
RefugiaLibrary<-file.path('/Users/darkbabine/Dropbox (BVRC)/_dev/Biodiversity/BC_Macro_Refugia/out/spatial')
RefugiaSpatialDir <- file.path('/Users/darkbabine/Dropbox (BVRC)/Projects/ClimateChange/BiodiversityCC/ClimateRefugia')
ConnectSpatialDir <- file.path('/Users/darkbabine/Dropbox (BVRC)/_dev/Biodiversity/BC_ConservationConnectivity')
